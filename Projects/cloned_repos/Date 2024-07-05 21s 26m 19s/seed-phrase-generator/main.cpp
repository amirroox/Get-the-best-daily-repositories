...
// my github: https://github.com/clomso/
// repository: https://github.com/clomso/seed-phrase-generator/
...
int main(int argc, char** argv)
{
  ...
  std::string title = "[Seed phrase Generate & Check - BTC; ETH; LTC; DOGE] - By Cosmo11";
	...
	DWORD webstat = 0;
	if(!inet::webstatus_check("https://www.blockchain.com/explorer") && webstatus != 200)
	{
